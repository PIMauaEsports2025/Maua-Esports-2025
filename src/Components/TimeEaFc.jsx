...
function TimeEaFc() {
    const jogadores = [
        { nome: 'LEO', nomeCompleto: 'Leonardo Ferreira Abrahão | ENG 2º ano', funcao: 'CAPITÃO' },
        { nome: 'GABE', nomeCompleto: 'Gabriel Ferreira Gimenez | ENG 1º ano', funcao: 'PLAYER' },
        { nome: 'EDU', nomeCompleto: 'Eduardo Girotto de Oliveira | ENG 1º ano', funcao: 'PLAYER' },
    ];
