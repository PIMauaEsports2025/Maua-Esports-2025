...
function Times() {
    const times = [
        ...
        { nome: 'EA FC 25', imagem: require('../assets/ui/fc25.png'), link: '/time-ea-fc' },
        { nome: 'League Of Legends', imagem: require('../assets/ui/lol.png'), link: '/time-league-of-legends' },
        { nome: 'Rocket League', imagem: rocketImage, link: '/time-rocket-league' },
        { nome: 'TFT - Team Fight Tactics', imagem: require('../assets/ui/tft.png'), link: '/time-tft' },
        { nome: "Tom Clancy's Rainbow Six Siege", imagem: rainbowImage, link: '/time-rainbow-six' },
        { nome: 'Valorant - Line Blue', imagem: valorantImage , link: '/time-valorant-blue' },
        { nome: 'Valorant - Line Purple', imagem: valorantImage , link: '/time-valorant-purple' },
        { nome: 'Valorant - Line White', imagem: valorantImage, link: '/time-valorant-white' }
    ];
    ...
    return (
        <div className="times-container">
            ...
            <main className="comeco-content">
                ...
                <p>
                    Representamos a Mauá com orgulho, levando inovação, tecnologia e espírito competitivo aos campos virtuais, construindo uma história de conquistas e paixão pelos e-sports.
                </p>
            </main>
