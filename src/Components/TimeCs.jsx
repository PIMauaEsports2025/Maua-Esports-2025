...
function TimeCs() {
    const jogadores = [
        ...
        { nome: 'RK', nomeCompleto: 'Robert Kevyn Gonçalves Gomes | CIC 2º ano', funcao: 'PLAYER' },
        { nome: 'VCL', nomeCompleto: 'Victhor das Virgens de Lima Castro | CIC 2º ano', funcao: 'PLAYER' },
        { nome: 'MYTHE', nomeCompleto: 'Guilherme Zanelli de Novaes | CIC 2º ano', funcao: 'PLAYER' },
        { nome: 'KINGEY', nomeCompleto: 'Bruno Saito Santos | ENG 1º ano', funcao: 'PLAYER' },
    ];
